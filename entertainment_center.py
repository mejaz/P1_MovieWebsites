...
movie1 = media.Movies(
  "Forrest Gump", 
  "images/forrest-gump-poster1.jpg", 
  "https://www.youtube.com/watch?v=uPIEn0M8su0", 
  "Tom Hanks and Gary Sinise"
  )
movie2 = media.Movies(
  "A Wednesday", 
  "images/a_wednesday.jpg", 
...
movie3 = media.Movies(
  ...
  "Leonardo Decaprio, Matt Damon and Jack Nicholson"
  )
movie4 = media.Movies(
  "Sholay", 
  "images/sholay.jpg", 
  "https://www.youtube.com/watch?v=36SMdfwisLg", 
  "Amitabh Bachchan and Dhamendra"
  )
movie5 = media.Movies(
  "The Incredible Hulk", 
  "images/hulk.jpg", 
